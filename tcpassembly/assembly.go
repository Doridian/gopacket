...
// (github.com/Doridian/gopacket, github.com/Doridian/gopacket/layers).
//
...
import (
	...
	"github.com/Doridian/gopacket/layers"
	"log"
	"sync"
	"time"
)

var memLog = flag.Bool("assembly_memuse_log", false, "If true, the github.com/Doridian/gopacket/tcpassembly library will log information regarding its memory use every once in a while.")
var debugLog = flag.Bool("assembly_debug_log", false, "If true, the github.com/Doridian/gopacket/tcpassembly library will log verbose debugging information (at least one line per packet)")
